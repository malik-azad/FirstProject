...
<section class="p-3 p-md-4 p-xl-5 " style="background-color: #D8DFEE;">
  <div class="container">
    <div class="card border-light-subtle shadow-sm">
      <div class="row g-0">
        <div class="col-12 col-md-6">
          <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="https://bootstrapbrain.com/demo/components/registrations/registration-4/assets/img/logo-img-1.webp" alt="BootstrapBrain Logo">
        </div>
        <div class="col-12 col-md-6">
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-5">
                  ...
                  <h3 class="fs-6 fw-normal text-secondary m-0">Enter your details to Sign Up</h3>
                </div>
              </div>
            </div>
